...
logger = logging.getLogger("agric_master.groq_service")


class GroqService:
    """
    Unified service for all model predictions using Groq API.
    ...
    def __init__(self):
        ...
        if not self.api_key:
            logger.warning("GROQ_API_KEY not set. Groq predictions will fail.")
    ...
    def predict_yield(self, crop_type: str, soil_type: str, rainfall_mm: float,
        ...
        """
        Use Groq to predict crop yield based on agricultural parameters.
        """
...
Only respond with valid JSON, no additional text."""
        ...
        try:
            ...
            raise ValueError(f"Invalid Groq response: {e}") from e

    def predict_disease(self, image_description: str) -> Dict[str, Any]:
        """
        Use Groq to identify plant disease from description.
        """
...
Only respond with valid JSON, no additional text."""
    ...
    def predict_price(self, crop_type: str, market_region: str, season: str, quality_grade: str) -> Dict[str, Any]:
        """
        Use Groq to estimate crop market price.
        """
...
Only respond with valid JSON, no additional text."""
    ...
    def predict_livestock_health(self, animal_type: str, symptoms: str, age_months: int,
        ...
        """
        Use Groq to assess livestock health status.
        """
...
Only respond with valid JSON, no additional text."""
    ...
    def predict_drought_risk(self, region: str, soil_moisture_percent: float,
        ...
        """
        Use Groq to assess drought risk for a region.
        """
